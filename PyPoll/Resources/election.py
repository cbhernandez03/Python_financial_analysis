...
# Assign a variable to save the file to a text page
file_save = os.path.join( "election_analysis.txt")

# Start of a total vote counter.
totalvotes = 0
...
with open(file_load) as election_data:
    ...
    for row in file_reader:
        ...
        # If candidate does not match any existing candidate, add the to candidate list.
